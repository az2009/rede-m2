...
class Payment extends \Az2009\Rede\Model\Method\Response
{
    ...
    /**
     * @var \Az2009\Rede\Model\Method\Cc\Transaction\Authorize
     */
    protected $_authorize;

    /**
     * @var \Az2009\Rede\Model\Method\Cc\Transaction\Capture
     */
    protected $_capture;

    /**
     * @var \Az2009\Rede\Model\Method\Cc\Transaction\General
     */
    protected $_pending;

    /**
     * @var \Az2009\Rede\Model\Method\Cc\Transaction\Unauthorized
     */
    protected $_unauthorized;

    /**
     * @var \Az2009\Rede\Model\Method\Cc\Transaction\Cancel
     */
    protected $_cancel;
    ...
    public function process()
    {
        ...
        $postback = $objManager->get(\Az2009\Rede\Model\Method\Cc\Postback::class);
