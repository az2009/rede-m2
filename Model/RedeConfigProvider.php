 ...
 */
namespace Az2009\Rede\Model;

use Magento\Framework\View\Asset\Source;

class RedeConfigProvider
...
implements \Magento\Checkout\Model\ConfigProviderInterface
{
    ...
    /**
     * @var \Az2009\Rede\Helper\Installment
     */
    ...
    public function __construct(
        ...
        \Az2009\Rede\Helper\Dc $helperdc,
        \Az2009\Rede\Helper\Installment $installment,
    ...
    public function getConfig()
    {
        ...
        if ($this->state->getAreaCode()
            ...
            $config['payment']['az2009_rede']['info_credit_card'] = [
    ...
    public function getIcons()
    {
        ...
        foreach (array_keys($types) as $code) {
            if (!array_key_exists($code, $this->icons)) {
                $asset = $this->ccConfig->createAsset('Az2009_Rede::images/cc/' . strtolower($code) . '.png');
