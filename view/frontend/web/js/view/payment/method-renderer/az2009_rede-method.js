...
define([
        ...
        'mage/translate',
        'Az2009_Rede/js/model/credit-card-validation/credit-card-data',
    ...
    function ($, Component, $t, creditCardData, cardNumberValidator, ko) {
        ...
        return Component.extend({
            defaults: {
                template: 'Az2009_Rede/payment/form-cc',
            ...
            initialize: function() {
                ...
                this.creditCardSave.subscribe(function(value) {
                    $('#payment_form_' + self.getCode() + ' #az2009_rede_cc_type_cvv_div, ' + '#payment_form_' + self.getCode() + ' .brandCard').show();
            ...
            getCcAvailableTypes: function () {
                return window.checkoutConfig.payment.az2009_rede.availableTypes;
            },
            ...
            getIcons: function (type) {
                return window.checkoutConfig.payment.az2009_rede.icons.hasOwnProperty(type) ?
                    window.checkoutConfig.payment.az2009_rede.icons[type]
                    : false;
            },
            ...
            {
                return window.checkoutConfig.payment.az2009_rede.cards;
            },
            ...
            hasCardSave:function() {
                var ccsave = window.checkoutConfig.payment.az2009_rede.cards;
            ...
            getInstallments: function() {
                var installments = window.checkoutConfig.payment.az2009_rede.installments;
                var values = {};
                if (installments) {
            ...
            isLoggedIn: function () {
                return window.checkoutConfig.payment.az2009_rede.is_logged_in;
            },
            ...
            getExpMonth: function () {
                var values = window.checkoutConfig.payment.az2009_rede.month;
            ...
            getExpYear: function () {
                var values = window.checkoutConfig.payment.az2009_rede.year;
                return _.map(values, function (value, key) {
                    return {
                        'key': key,
                        'value': value
            ...
            loadInstallments: function () {
                ...
                $(document).on('focusout', '#az2009_rede_cc_number_c', function(){
                    $.ajax({
                        url: '/rede/installments/index',
                        type: 'POST',
                        dataType: 'HTML',
                        success: function (response) {
                            $('#az2009_rede_cc_installments').html(response)
                        }
                    });
                });
            },
